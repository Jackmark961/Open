...
void addstudent()
{
    ...
    fp=fopen("information.txt","a"); //You can give any file name. Give the name with extention or without extention.
...
void studentrecord()
{
    ...
    fclose(fp);
}// end of displaying student details
...
void searchstudent()
{
    ...
    fclose(fp);
}// end of searching student details
...
}// end of deleting student records